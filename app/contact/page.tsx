    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          ...
          className="w-full py-4 bg-black text-white font-mono text-xs font-bold uppercase tracking-widest hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-3"
        >
          {isSubmitting ? (
    ...
    >
      <div className="relative z-10 w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center">
          ...
          <p className="reveal-anim text-lg text-gray-500 mb-12 font-mono max-w-md">
            {t.subtitle}
          </p>
