...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative flex min-h-screen w-full flex-col items-center bg-[#FAFAFA] overflow-hidden pt-24 md:pt-32 pb-32"
    >
      {/* --- GRID BACKGROUND --- */}
      <div
      ...
      <div className="relative z-30 flex flex-col items-center text-center w-full xl:max-w-7xl px-4 md:px-6">
        ...
        <div className="flex gap-4 mb-16">
          <button className="hero-btn group relative px-6 py-3 bg-[#111] text-white text-xs font-mono font-bold uppercase tracking-widest hover:bg-black transition-all rounded-sm shadow-xl shadow-black/10">
            Start Project
          ...
          <button className="hero-btn group px-6 py-3 bg-white border border-[#E5E5E5] text-[#111] text-xs font-mono font-bold uppercase tracking-widest hover:bg-gray-50 transition-all rounded-sm">
            View Pricing
          </button>
        </div>

        {/* --- MAIN DASHBOARD VISUAL (CENTER) --- */}
              ...
              <div className="dash-item col-span-1 md:col-span-7 bg-white rounded-lg border border-gray-200 shadow-sm p-5 flex flex-col h-full min-h-[280px]">
                ...
                <div className="font-mono text-[10px] md:text-xs leading-loose text-gray-400 flex-1 overflow-hidden">
                  ...
                  <div className="flex">
                    ...
                    <span className="text-purple-600">import</span>
                    <span className="text-gray-800">&nbsp;{`{ motion }`}</span>
                    <span className="text-purple-600">&nbsp;from</span>
                    <span className="text-green-600">
                      &nbsp;&apos;framer-motion&apos;;
                    </span>
